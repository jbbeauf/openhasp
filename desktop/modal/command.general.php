...
<div class="col-xs-12">
    ...
    <div class="input-group pull-right" style="display:inline-flex;">
        ...
        <div id='messaegeChangesDetected' style="display: none;"><i>{{Changement en cours}}</i></div>&nbsp;&nbsp;
            ...
            <table id="table_manage_cmd_general" class="table table-bordered">
                <thead>
                    <tr>
                        ...
                        <th style="min-width:400px;width:600px;">{{Commandes associée}}</th>
                    </tr>
                </thead>
                <?php
                    foreach($json_data as $groupKey => $groupElement) {
                        echo '<tbody>';
                        echo '<tr class="sectionTitle" style="height: 10px;">';
                        echo '<td colspan="3">';
                        ...
                        echo '</tr>';
                        echo '</tbody>';
                        echo '<tbody id="group_' . $groupKey . '" class="collapse" aria-expanded="true">';
                        foreach($groupElement['command'] as $commandKey => $commandElement) {
